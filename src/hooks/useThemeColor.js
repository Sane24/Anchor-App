...
export const colorThemes = [
  ...
  },
  {
    ...
    label: 'Lavender',
    emoji: '🪻',
    vars: { '--green': '#706285', '--green-ink': '#F5F2E8', '--card-alt': '#EDE7F2' },
  ...
  },
  {
    ...
    label: 'Ocean',
    emoji: '🌊',
    vars: { '--green': '#586D82', '--green-ink': '#F5F2E8', '--card-alt': '#E7EDF2' },
  ...
  },
  {
    ...
    label: 'Terracotta',
    emoji: '🍊',
    vars: { '--green': '#9A5832', '--green-ink': '#F5F2E8', '--card-alt': '#F6E6D7' },
